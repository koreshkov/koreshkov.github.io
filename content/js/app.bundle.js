...
/* harmony import */ var _components_navigation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/navigation */ "./js/components/navigation.js");
/* harmony import */ var _components_section__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/section */ "./js/components/section.js");
...
/* harmony import */ var _views_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/index */ "./js/views/index.js");
/* harmony import */ var _views_intro__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/intro */ "./js/views/intro.js");
/* harmony import */ var _views_hello__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/hello */ "./js/views/hello.js");
/* harmony import */ var _views_story__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/story */ "./js/views/story.js");
/* harmony import */ var _views_year__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/year */ "./js/views/year.js");
/* harmony import */ var _views_skills__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/skills */ "./js/views/skills.js");
/* harmony import */ var _views_area__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/area */ "./js/views/area.js");
/* harmony import */ var _views_hobbies__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./views/hobbies */ "./js/views/hobbies.js");
/* harmony import */ var _views_contact__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./views/contact */ "./js/views/contact.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    template: `
        <p-section :backdrop="'bg-l-5'">
            <div class="unit-5 scroll-fade">
                    <div class="module-rte">
                        <label class="label">/hello</label>
                        <h1>My name is<br />Andrei Koreshkov</h1>
                        <p>
                            I'm a 32 years old web developer located in Saint Peterburg, Russia.<br/>
                            I have 7 years of experience in full-stack web development with the main focus on frontend.<br/>
                            I would like to tell you my story of first <code>index.html</code> and how far it took me.
                        </p>
                        <p>
                            <router-link to="/story/2002" class="btn">Read my story</router-link>
                        </p>
                    </div>
            </div>
            <div class="unit-3 full-height bg-image-cover slide-fade-right" style="background-image: url('/images/IMG_3009.jpg');">
            </div>
        </p-section>
    `,
    data() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    template: `
        <p-section :backdrop="'bg-r-7'">
            <div class="unit-1 scroll-fade"></div>
            <div class="unit-7 scroll-fade">
                <div class="module-rte">
                    <label class="label">/hobbies</label>
                    <h1>What am I <b>fond of</b>?</h1>
                    <div class="row">
                        <div class="col-6" v-for="hobby in hobbies">
                            <img class="skill-icon" :src="'/images/' + hobby.icon" v-if="hobby.icon">
                            <h3 class="skill-title">{{hobby.title}}</h3>
                            <p v-html="hobby.summary"></p>
                        </div>
                    </div>
                </div>
            </div>
